...
const Review = () => {
  ...
  // Use the correct `submitExam` function
      ...
      <div className="w-full max-w-3xl">
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-3">
            <Clock size={20} />
            <CountdownTimer seconds={timeLeft} warnThreshold={300} size="lg" />
          </div>
        </header>
        {autoSubmitTriggered && (
          <div className="mb-6 rounded-2xl border border-warning/40 bg-warning/10 px-4 py-3 text-center text-warning font-bold text-sm shadow-inner">
            Waktu habis, jawaban sedang dikirim otomatis. Anda akan diarahkan ke hasil segera.
          </div>
        )}
